...
exports.default = async (data) => {
    ...
    ctx === null || ctx === void 0 ? void 0 : ctx.step("Fetching review by ID");
    const result = await (0, query_1.getRecord)("ecommerceReview", params.id, [
        {
    ...
    ctx === null || ctx === void 0 ? void 0 : ctx.success("Review retrieved successfully");
    return result;
};
